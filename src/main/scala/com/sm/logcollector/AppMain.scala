...
object AppMain {
  ...
  /**
    * 公共字段设置
    */
  private def generateComFields: JSONObject = {
  ...
  /**
    * 商品展示事件
    */
  private def generateDisplay: JSONObject = {
  ...
  /**
    * 商品列表
    */
  private def generateNewList: JSONObject = {
  ...
  /**
    * 广告相关字段
    */
  private def generateAd: JSONObject = {
    val appAd = new AppAd
    // 入口
    var flag = rand.nextInt(3) + 1
    appAd.setEntry(flag + "")
  ...
  /**
    * 前台活跃
    */
  private def generatbeforeground: JSONObject = {
  ...
  /**
    * 后台活跃
    */
  private def generateBackground: JSONObject = {
  ...
  /**
    * 错误日志数据
    */
  private def generateError: JSONObject = {
    ...
    val jsonObject = JSON.toJSON(appErrorLog).asInstanceOf[JSONObject]
  ...
  /**
    ...
    */
  private def packEventJson(eventName: String, jsonObject: JSONObject) = {
  ...
  /**
    * 收藏
    */
  private def generateFavorites:JSONObject = {
    ...
    val jsonObject = JSON.toJSON(favorites).asInstanceOf[JSONObject]
  ...
  /**
    * 点赞
    */
  private def generatePraise:JSONObject = {
    ...
    val jsonObject = JSON.toJSON(praise).asInstanceOf[JSONObject]
  ...
  /**
    * 评论
    */
  private def generateComment:JSONObject = {
    ...
    val jsonObject = JSON.toJSON(comment).asInstanceOf[JSONObject]
